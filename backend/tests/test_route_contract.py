...
EXPECTED_ROUTES = {
    ...
    ("POST", "/api/practice/drills/{drill_code}/attempts"), ("GET", "/api/practice/drills/attempts"),
    ...
    ("DELETE", "/api/coach/reviews/{review_uuid}"),
    ...
    ("PUT", "/api/enterprise/rubrics/{rubric_uuid}"), ("DELETE", "/api/enterprise/rubrics/{rubric_uuid}"),
    ...
    ("PUT", "/api/enterprise/organizations/{org_uuid}/questions/{question_uuid}"),
    ("DELETE", "/api/enterprise/organizations/{org_uuid}/questions/{question_uuid}"),
    ("GET", "/api/enterprise/organizations/{org_uuid}/audit-logs"),
    ("GET", "/api/enterprise/organizations/{org_uuid}/export"),
    ("GET", "/api/enterprise/organizations/{org_uuid}/retention/preview"),
    ("POST", "/api/enterprise/organizations/{org_uuid}/retention/run"),
